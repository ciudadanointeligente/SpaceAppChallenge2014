...
describe LogsController do
  ...
  let(:valid_attributes) { { "raw" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved log as @log" do
        ...
        post :create, {:log => { "raw" => "invalid value" }}, valid_session
        assigns(:log).should be_a_new(Log)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested log" do
        ...
        Log.any_instance.should_receive(:update).with({ "raw" => "MyText" })
        put :update, {:id => log.to_param, :log => { "raw" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the log as @log" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Log.any_instance.stub(:save).and_return(false)
        put :update, {:id => log.to_param, :log => { "raw" => "invalid value" }}, valid_session
        assigns(:log).should eq(log)
      end
