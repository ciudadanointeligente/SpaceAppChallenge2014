...
describe ObservationsController do
  ...
  let(:valid_attributes) { { "source_object" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved observation as @observation" do
        ...
        post :create, {:observation => { "source_object" => "invalid value" }}, valid_session
        assigns(:observation).should be_a_new(Observation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested observation" do
        ...
        Observation.any_instance.should_receive(:update).with({ "source_object" => "MyText" })
        put :update, {:id => observation.to_param, :observation => { "source_object" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the observation as @observation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Observation.any_instance.stub(:save).and_return(false)
        put :update, {:id => observation.to_param, :observation => { "source_object" => "invalid value" }}, valid_session
        assigns(:observation).should eq(observation)
      end
